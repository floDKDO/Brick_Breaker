#ifndef __MENU__JEU__TERMINE__HPP__
#define __MENU__JEU__TERMINE__HPP__

#include "menu.hpp"
#include "bouton.hpp"
#include "texte.hpp"

class MenuJeuTermine : public Menu
{
    public:
        MenuJeuTermine(const SingletonSysteme* const sing_syst);
